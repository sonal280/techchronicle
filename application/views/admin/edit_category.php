<?php 
foreach ($category_detail->result() as $detail) {
    $cat_name = $detail->cat_name;
    $cat_status = $detail->cat_status;
    $cat_image = $detail->cat_image;
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="breadcome-heading">
                                            ...
                                            <span style="padding-left: 15px">Edit Category</span>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            ...
                                                            <div class="form-group-inner">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                        <input type="text" class="form-control" name="cat_name" id="cat_name" value="<?=$cat_name?>" />
                                                                    ...
                                                                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                         <div class="chosen-select-single mg-b-20">
                                                                            ...
                                                                            <select data-placeholder="Choose a Country..." class="chosen-select form-control" tabindex="-1" name="cat_status" id="cat_status">
                                                                                    <option <?php if ($cat_status== 1 ) {echo "selected";} ?> value="1">Active</option>
                                                                                    <option <?php if ($cat_status== 0 ) {echo "selected";} ?> value="0">Deactive</option>
                                                                    ...
                                                                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                                                                        <div class="file-upload-inner file-upload-inner-right ts-forms">
                                                                            <div class="input append-big-btn">
                                                                                ...
                                                                                <img src="<?=base_url('images/category/'.$cat_image)?>" height="150px" width="150px" alt="">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
      ...
      <script>
        ...
        $('#category_form').on('submit', function(e) {
            ...
            // if ( $('#category_form').valid()) {
                ...
                $.ajax({
                    url:"<?=base_url('admin/edit_new_category')?>",
                    method:'POST',
                    data: formData,
                    contentType:false,
                    processData:false,
