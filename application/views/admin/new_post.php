                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="breadcome-heading">
                                            <div class="breadcome-heading">
                                                ...
                                                <span style="padding-left: 15px">Add Post</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><a href="<?=base_url('admin/category')?>">Post</a> <span class="bread-slash">/</span>
                                             ...
                                             <li><span class="bread-blod">New Post</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="all-form-element-inner">
                                                        <form action="<?=base_url('admin/add_new_post')?>" method="POST" enctype="multipart/form-data" id="post_form">
                                                                         ...
                                                                         <div class="chosen-select-single mg-b-20">
                                                                            ...
                                                                            <?php 
                                                                                foreach ($cat_result as $cat_detail) { ?>
                                                                                   <option value="<?=$cat_detail->cat_id?>"><?=$cat_detail->cat_name?></option>
                                                                               <?php 
                                                                                }
                                                                             ?>
                                                                            </select>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                                                      <!--  <input type="file" name="post_image" class="form-control"> --> 
                                                                        <textarea id="editor" cols="20" rows="10" class="form-control ckeditor" name="post_description" required=""></textarea> 
                                                                    </div>
                                                                </div>
                                                            </div>
